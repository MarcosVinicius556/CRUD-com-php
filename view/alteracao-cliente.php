<div class="p-3">
    ...
    <input type="hidden" name="codigo" value="<?php print $cliente->codigo; ?>"> 
    ...
    <div class="mb-3 col-md-4">
        ...
        <input type="text" name="inputCpf" value="<?php print $cliente->cpf; ?>" class="form-control CPF" required>
    </div>
    <div class="mb-3 col-md-4">
        <label for="inputTelefone">Telefone</label>
        <input type="tel" name="inputTelefone" value="<?php print $cliente->telefone; ?>" class="form-control TELEFONE">
    </div>
    <div class="mb-3 col-md-4">
